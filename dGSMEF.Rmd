...
$$ fraq{dX}{dt} = \mu(X) \rightarrow X = X_0{\rm e}^\mu\delta(t) $$
...
$$ \Phi_P = \rho\times\frac{\lamda}{\kappa_n} $$
$$ \Phi_R = \rho\times\(r_0 + frac{\lamda}{\kappa_t}) $$
$$ 1 - \Phi_Q  = \rho\𝑟_𝑚𝑎𝑥 $$
...
where $\Phi_C = \rho\times(r_max - r_0) ≈ 0.48$ , 𝜆(𝜙𝑈) is the growth rate with 𝜙𝑈 in the proteome, and 𝜆(𝜙𝑈 = 0) is the growth rate without unnecessary protein in the proteome.
